...
# Processes each image using  uses mPLUG-OWL2 a vision-language model.(coherence - semantic)
# Evaluates images based on either coherence or semantic content.
# Saves the processed tensors for further analysis.
